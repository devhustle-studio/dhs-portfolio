    ...
    <section className="mx-auto max-w-7xl px-4 py-12 text-slate-800">
      ...
      <div className="grid grid-cols-12 gap-4">
        ...
        <BounceCard className="col-span-12 md:col-span-4">
          ...
          <div style={{backgroundImage:"url('https://cdn.dribbble.com/userupload/15488505/file/original-46423da1c8db0f1fef7dd47e7c52b13a.jpg?resize=1024x560')"}}  className="absolute bottom-0 left-4 right-4 top-20 translate-y-8 rounded-t-2xl bg-gradient-to-br from-pink-400 to-red-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
